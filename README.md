...
## Добавление заданий
Адрес, куда слать запросы: https://tools.moab.pro/api/Parse/AddTasks
...
Адрес, куда слать запросы: https://tools.moab.pro/api/Parse/Check
...
Адрес, куда слать запросы: https://tools.moab.pro/api/Parse/TasksList
...
Приостановить задание (поставить на паузу) можно, отправив на адрес https://tools.moab.pro/api/Parse/PauseTask запрос вида:
...
Продолжить поставленное ранее на паузу задание можно, отправив аналогичный запрос на адрес https://tools.moab.pro/api/Parse/RunTask
...
По всем вопросам, связанным с интеграцией API MOAB Tools в вашу систему, вы можете обращаться в техподдержку сервиса https://tools.moab.pro/Support
