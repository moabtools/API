...
regions  | строка | Список регионов через запятую, пример "256,13,1"<br/>Все коды регионов - https://dobrovkonstantin.ru/yandexgeo<br/>По умолчанию – пустая строка (все регионы).
...
По всем вопросам, связанным с интеграцией API MOAB Tools в вашу систему, вы можете обращаться в техподдержку сервиса https://moab.tools/Support
